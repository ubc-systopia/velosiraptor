...
#define _PAGE_TABLE		 (__PP|__RW|_USR|___A|   0|___D|   0|   0)
...
#define __PAGE_KERNEL_ENC	(__PAGE_KERNEL    )
#define __PAGE_KERNEL_ENC_WP	(__PAGE_KERNEL_WP )
