...
#define  __alloc_pages_node(...)		__alloc_pages_node_noprof(__VA_ARGS__)
...
#define  alloc_pages_node(...)			alloc_pages_node_noprof(__VA_ARGS__)
...
{
	return alloc_pages_node_noprof(0, gfp_mask, order);
}
...
#define alloc_pages(...)			alloc_pages_noprof(__VA_ARGS__)
